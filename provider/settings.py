...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.getenv('EMAIL_USER', config.get('EMAIL_USER'))
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_PASSWORD', config.get('EMAIL_PASSWORD'))
